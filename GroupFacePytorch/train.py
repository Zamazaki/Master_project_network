...
if __name__ == '__main__':
    ...
    pretrained_model = "checkpoints/Epoch_Final_acc_0.34.pth"
    pretrained_centers = "checkpoints/Epoch_Final_centers.pth"
    ...
    criteria_arc = ArcFaceLoss(num_classes=10, m=0.5, partial_fc_rate=1, use_gpu=False)
